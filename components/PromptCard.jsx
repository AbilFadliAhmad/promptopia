    ...
    <div className="prompt_card">
      <div className="flex justify-between items-start gap-5">
        ...
        <div className="copy_btn" onClick={handleCopy}>
          <Image alt="copy_btn" src={copied === post.prompt ? '/assets/icons/tick.svg' : '/assets/icons/copy.svg'} width={12} height={12} />
        </div>
      </div>
      ...
      {session?.user.id === post.creator._id && pathName === '/profile' && (
        <div className="mt-4 pt-3 flex-center gap-4 border-t border-gray-300">
