...
const Form = ({ type, post, setPost, submitting, handleSubmit }) => {
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <form onSubmit={handleSubmit} className="mt-10 w-full max-w-2xl gap-7 flex flex-col glassmorphism ">
        <label htmlFor="">
        ...
        <label htmlFor="">
          <span className="font-satoshi font-semibold text-base text-gray-700">Tag<span className="font-normal  "> (#product, #idea, #web...)</span></span>
          <textarea
            name="tag"
            value={post.tag}
            onChange={(e) => setPost({ ...post, [e.target.name]: e.target.value })}
